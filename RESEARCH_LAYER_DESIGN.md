...
**Europe PMC** is the primary source: free REST API, no key, covers PubMed and
preprint servers, flags open-access status, and serves full text for OA articles.
**PubMed E-utilities** as secondary for metadata and MeSH terms. **DOAJ**, **PLOS**,
**BMC Veterinary Research**, **Frontiers in Veterinary Science** where not already
covered. **WSAVA** and **FEDIAF** guidance documents as standing references.
